>[!note] Implication
>For two [[1.1 Propositional Logic|propositions]] $P$ (the *hypothesis*) and $Q$ (the *conclusion*), and some (optional) [[1.2 Quantifiers|quantifiers]], we can say that $P$ implies $Q$ such that
>$$(P \implies Q)$$
>
...
>Which of the following implications are always true, regardless of $P$? Give a counterexample for each false assertion.
>>[!example] $\forall x \forall y P(x,y) \implies \forall y \forall x P(x,y)$
