...
>The [[2.5a Expectation|expected]] payoff to player $i \in N$ playing a [[2.5a Mixed Strategies|mixed strategy]] $\sigma_i(s_i^k)$ for $s_i^k \in S_i$, with other players playing pure strategies $s_{-i}$, is denoted as
